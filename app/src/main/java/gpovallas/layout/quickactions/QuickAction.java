package gpovallas.layout.quickactions;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
	...
	/**
     * Hide action item at an index
     * 
     * @param index  Index of item (position from callback)
     * 
     * @return  Action Item at the position
     */
    public void hideActionItem(int index){
    	mTrack.getChildAt(index).setVisibility(View.GONE);
    }
    
    /**
     * Show action item at an index
     * 
     * @param index  Index of item (position from callback)
     * 
     * @return  Action Item at the position
     */
    public void showActionItem(int index){
    	mTrack.getChildAt(index).setVisibility(View.VISIBLE);
    }
}