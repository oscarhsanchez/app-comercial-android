package gpovallas.app.constants;

public class GPOVallasConstants {

	// Shared key properties
	public static String ACCESS_TOKEN = "access_token";
	public static String RENEW_TOKEN = "renew_token";
	
	// Database tables
	public static String DB_TABLE_PARAMETROS = "TPVPARAMETERS";
