package gpovallas.com.numberPicker;
...
public class NumberPicker extends LinearLayout implements OnClickListener,
    ...
    private static final int DEFAULT_FACTOR_INCR = 1;
    ...
    private final Runnable mRunnable = new Runnable() {
        public void run() {
            if (mIncrement) {
                changeCurrent(mCurrent + mFactorIncrement);
    ...
    private TextWatcher textWatcher = new TextWatcher(){
		...
		public void afterTextChanged(Editable s){
			...
			if ("".equals(str) || !Numbers.checkIfInteger(str)){
				mPrevious = mCurrent;
				mCurrent = null;
			}else{

				Integer val = getSelectedPos(str);
    ...
    protected Integer mPrevious;
    private OnChangedListener mListener;
    private Formatter mFormatter;
    private long mSpeed = 300;
    protected Integer mFactorIncrement;
    ...
    public NumberPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mStart = DEFAULT_MIN;
        mEnd = DEFAULT_MAX;
        mFactorIncrement = DEFAULT_FACTOR_INCR;
        mCurrent = 1;
    }
    ...
    private Integer getSelectedPos(String str) {
    	if ("".equals(str) || !Numbers.checkIfInteger(str)){
    		return 0;
    	}
    ...
    public static NumberPicker getNumberPicker(Context c){
    	LayoutInflater inflater = (LayoutInflater) c.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View npView = inflater.inflate(R.layout.number_picker_pref, null);
		NumberPicker np = (NumberPicker) npView.findViewById(R.id.pref_num_picker);
		return np;
    }

    public void setFactorIncrement(int factor) {
    	mFactorIncrement = factor;
    }
